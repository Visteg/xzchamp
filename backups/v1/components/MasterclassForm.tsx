...
export default function MasterclassForm({ onClose }: MasterclassFormProps) {
  ...
  return (
    ...
    >
      <div
        className="relative bg-[var(--bg-color)] border-2 border-[var(--neon-blue)] rounded-3xl max-w-lg w-full shadow-[0_0_40px_var(--neon-blue)] max-h-[90vh] overflow-y-auto my-auto"
        style={{
      ...
      >
        <div className="p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-4 px-6 rounded-full bg-[var(--neon-blue)] text-white font-['Unbounded'] font-bold uppercase tracking-wide transition-all duration-300 hover:shadow-[0_0_30px_var(--neon-blue)] hover:scale-105 mt-6"
            >
              Отправить заявку
            </button>
          </form>
